...
class BookingServiceTest {
    ...
    private static final String USER_ID = "bbbbbbbbbbbbbbbbbbbbbbbb";
    private static final String ADMIN_ID = "cccccccccccccccccccccccc";
    private static final String BOOKING_ID = "dddddddddddddddddddddddd";
    ...
    void setUp() {
        ...
        resource = Resource.builder()
                .id(RES_ID).name("Lab 1").type(ResourceType.LAB)
        ...
        admin = User.builder()
                .id(ADMIN_ID).email("admin@test.com").name("Admin User")
    ...
    void createBooking_Success() {
        when(resourceRepository.findById(RES_ID)).thenReturn(Optional.of(resource));
    ...
    void cancelBooking_Success() {
        ...
        bookingService.cancelBooking(BOOKING_ID, USER_ID, false);
    ...
    void cancelBooking_Unauthorized() {
        ...
        assertThatThrownBy(() -> bookingService.cancelBooking(BOOKING_ID, "u99", false))
    ...
    void cancelBooking_AdminSuccess() {
        ...
        bookingService.cancelBooking(BOOKING_ID, "admin-id", true);
    ...
    void cancelBooking_AlreadyCancelled() {
        ...
        assertThatThrownBy(() -> bookingService.cancelBooking(BOOKING_ID, USER_ID, false))
                .isInstanceOf(BadRequestException.class)
    ...
    void approveBooking_Success() {
        ...
        bookingService.approveBooking(BOOKING_ID, reviewRequest, ADMIN_ID);

        assertThat(booking.getStatus()).isEqualTo(BookingStatus.APPROVED);
        verify(notificationService).sendNotification(eq(USER_ID), any(), any(), any(), any(), any());
    }
    ...
    void rejectBooking_Success() {
        ...
        bookingService.rejectBooking(BOOKING_ID, reviewRequest, ADMIN_ID);
    ...
    void approveBooking_NotPending() {
        ...
        assertThatThrownBy(() -> bookingService.approveBooking(BOOKING_ID, new BookingReviewRequest(), ADMIN_ID))
                .isInstanceOf(BadRequestException.class)
    ...
    void getBookingById_Success() {
        ...
        BookingResponse response = bookingService.getBookingById(BOOKING_ID);
